...
namespace UiParticles
{
    ...
    public class UiParticles : MaskableGraphic
    {
        ...
        private void GenerateParticlesBillboards (VertexHelper vh)
        {
            ...
            var velocityOverTimeX = ParticleSystem.velocityOverLifetime.x;
            var velocityOverTimeY = ParticleSystem.velocityOverLifetime.y;
            var velocityOverTimeZ = ParticleSystem.velocityOverLifetime.z;
        ...
        private static void CalculateUvs (ParticleSystem.Particle particle, ParticleSystem.MinMaxCurve frameOverTime,
            ParticleSystem.TextureSheetAnimationModule textureSheetAnimationModule, float timeAlive, out Vector2 uv0,
            out Vector2 uv1, out Vector2 uv2,
            out Vector2 uv3)
        {
