...
namespace KKSFramework.Editor
{
    public class CustomHierarchyColorWindow : EditorWindow
    {
        ...
        private void OnGUI ()
        {
            ...
            EditorPrefs.SetString (nameof(CustomHierarchyEditor.ActiveNameTextColor), CustomHierarchyEditor.ActiveNameTextColor.ToRGBHex ());
            EditorPrefs.SetString (nameof(CustomHierarchyEditor.InactiveNameTextColor), CustomHierarchyEditor.InactiveNameTextColor.ToRGBHex ());
            EditorPrefs.SetString (nameof(CustomHierarchyEditor.BackGroundColor), CustomHierarchyEditor.BackGroundColor.ToRGBHex ());
        }
    }
}